...
router.get('/', (req, res) => {
    ...
    console.log("get request in primary")
...
router.post('/', (req, res) => {
    ...
    const queryInsert = {
        text: `INSERT INTO public.primary_pump_section(
    ...
    const querycount = {
        text: `SELECT count(1) FROM primary_pump_section  WHERE pump_section_id=1;`,
    };

    const queryUpdate = {
        text: `UPDATE public.primary_pump_section
